...
when drafting and viewing the survey afterwards.
...
This lib has an easy-to-use API, is free and open-source, embeds without an iFrame, and has some nice UI that comes with it. I
